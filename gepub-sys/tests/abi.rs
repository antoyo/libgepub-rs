...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    ("GepubTextChunkType", Layout {size: size_of::<GepubTextChunkType>(), alignment: align_of::<GepubTextChunkType>()}),
];

const RUST_CONSTANTS: &[(&str, &str)] = &[
    ("(gint) GEPUBTextBold", "1"),
    ("(gint) GEPUBTextHeader", "0"),
    ("(gint) GEPUBTextItalic", "2"),
    ("(gint) GEPUBTextNormal", "3"),
    ("GEPUB_META_AUTHOR", "creator"),
    ("GEPUB_META_DESC", "description"),
    ("GEPUB_META_ID", "identifier"),
    ("GEPUB_META_LANG", "language"),
    ("GEPUB_META_TITLE", "title"),
];
